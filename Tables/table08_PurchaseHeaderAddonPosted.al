table 50008 "Purchase Header Addon Posted"
{
    // version NAVW17.00

    // TAL0.1 2018/01/22 VC review purchase lines records, reference to out of range license

    Caption = 'Purchase Header';
    DataCaptionFields = "No.", "Buy-from Vendor Name";
    LookupPageId = "Purchase List Addon P";
    ...
    begin
        PurchLineAP.Reset;
        PurchLineAP.SetRange("Document Type", "Document Type");
        PurchLineAP.SetRange("Document No.", "No.");
        if PurchLineAP.Find('=') then
            PurchLineAP.Delete(true);
    end;
    ...
    var
        ...
        PurchLine: Record "Purchase Line Addon Posted";
        xPurchLine: Record "Purchase Line Addon Posted";
        ...
        PurchLineAP: Record "Purchase Line Addon Posted";
    ...
    begin
        ...
        if PurchLine.FindSet(true, false) then begin
            ...
            repeat
                ...
                PurchLine.UpdatePricesFromJobJnlLine;
                PurchLine.Modify;
            until PurchLine.Next = 0;
        end;
    end;
