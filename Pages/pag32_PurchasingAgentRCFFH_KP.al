page 50032 "Purchasing Agent RC FFH KP"
{
    Caption = 'Purchasing Agent FFH KP';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        area(Reporting)
        {
            ...
            action("Report Boxes Statement")
            {
                ...
                ToolTip = 'Executes the Report Boxes Statement action.';
            }
            ...
            action("Report Boxes Statement Summary")
            {
                ApplicationArea = All;
                RunObject = report "Boxes Statement Summary";
                Caption = 'Boxes Statement Summary';
                ToolTip = 'Executes the Boxes Statement Summary action.';
            }
        }
        area(embedding)
        {
        ...
        area(sections)
        {
            ...
            group(Boxes)
            {
                action("Purchase Boxes List")
                {
                    ...
                    ToolTip = 'Executes the Purchase Boxes List action.';
                }
            ...
            group(Setup)
            {
                ...
                action("Lot Sample")
                {
                    ...
                    ToolTip = 'Executes the Lot Sample action.';
                }
            }
        }
        area(Creation)
