report 50040 "Proforma Invoice"
{
    // version NAVW17.00

    // TAL0.2 2021/06/23 VC review margins
    // TAL0.4 2022/01/26 VC Design COC No.
    // TAL0.5 2022/11/26 VC Option to Hide Global Gap
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep40_50040_ProformaInvoice.rdlc';

    CaptionML = ELL = 'Proforma Invoice',
                ENU = 'Proforma Invoice';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(VATRegNo_SalesHeader; "Sales Header"."VAT Registration No." + ' ' + vG_TIC)
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        //+1.0.0.297
                        column(CountryRegionofOriginCode; "Sales Line"."Country/Region of Origin Code")
                        {
                        }
                        ...
                        column(Category9; "Sales Line"."Category 9")
                        {
                        }
            ...
            begin
                ...
                if "Sales Header"."Sell-to County" = "Sales Header"."Sell-to City" then begin
                    "Sales Header"."Sell-to County" := '';
                end;

                if "Sales Header"."Bill-to County" = "Sales Header"."Bill-to City" then begin
                ...
                if "Sales Header"."Ship-to County" = "Sales Header"."Ship-to City" then begin
