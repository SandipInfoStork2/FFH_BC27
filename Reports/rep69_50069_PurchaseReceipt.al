report 50069 "Purchase - Receipt FFH"
{
    // TAL0.1 2021/11/03 VC Design COC No.
    // TAL0.2 2021/11/03 VC Option to Hide Global Gap
    // TAL0.3 2021/12/20 ANP Add received by on layout
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep69_50069_PurchaseReceipt.rdlc';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(TransferFrom; "Purch. Rcpt. Header"."Transfer-from Code")
            {

            }
            column(TransferTo; "Purch. Rcpt. Header"."Transfer-to Code")
            {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ReceivingTemperature_Header; "Purch. Rcpt. Header"."Receiving Temperature")
                    {

                    }

                    column(ReceivingQualityControl_Header; "Purch. Rcpt. Header"."Receiving Quality Control")
                    {
    ...
    var
        LocationCodeLbl: Label 'Location Code';//TAL 1.0.0.202
        //TAL 1.0.0.201 >>
