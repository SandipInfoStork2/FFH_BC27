//REFERENCE https://yzhums.com/23873/

report 50054 "Sales - Quote Lidl"
{
    RDLCLayout = './Layouts/rep54_50054_SalesQuoteLidl.rdlc';
    WordLayout = './Layouts/rep54_50054_SalesQuoteLidl.docx';

    ExcelLayout = './Layouts/rep54_50054_SalesQuoteLidl.xlsx';
    Caption = 'Sales - Quote Lidl';
    DefaultLayout = Excel;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(DocumentDate; Format("Document Date", 0, 4))  //Format("Document Date", 0, '<Day,2>/<Month,2>/<Year4>')//ormat("Document Date", 0, 4)
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(ProductClass; "Product Class")
                {

                }
                column(PackageQty; "Package Qty")
                {


                }
                column(CalibrationMin; "Calibration Min.")
                {

                }
                column(CalibrationMax; "Calibration Max.")
                {

                }
                column(CalibrationUOM; "Calibration UOM")
                {
                ...
                column(PricePreviousWeekBox; "Price Previous Week Box")
                {

                }
                column(PricePreviousWeekPCS; "Price Previous Week PCS")
                {

                }
                column(PricePreviousWeekKG; "Price Previous Week KG")
                {

                }
                column(PriceBox; "Price Box")
                {

                }
                column(PricePCS; "Price PCS")
                {

                }
                column(PriceKG; "Price KG")
                {
                ...
                column(QtyBoxDate1; "Qty Box Date 1")
                {

                }

                column(QtyBoxDate2; "Qty Box Date 2")
                {

                }

                column(QtyBoxDate3; "Qty Box Date 3")
                {

                }

                column(QtyBoxDate4; "Qty Box Date 4")
                {

                }

                column(QtyBoxDate5; "Qty Box Date 5")
                {

                }

                column(QtyBoxDate6; "Qty Box Date 6")
                {

                }

                column(QtyBoxDate7; "Qty Box Date 7")
                {

                }
                column(QtyBoxDate8; "Qty Box Date 8")
                {

                }
                column(TotalQtyonBoxes; "Total Qty on Boxes")
                {

                }
                column(AdditionalInformation; "Additional Information")
                {

                }
                column(PressureMin; "Pressure Min.")
                {

                }
                column(PressureMax; "Pressure Max.")
                {

                }
                column(BrixMin; "Brix Min")
                {
                ...
                column(QC1Min; "QC 1 Min")
                {

                }
                column(QC1Max; "QC 1 Max")
                {

                }
                column(QC1Text; "QC 1 Text")
                {

                }

                column(QC2Min; "QC 2 Min")
                {

                }
                column(QC2Max; "QC 2 Max")
                {

                }
                column(QC2Text; "QC 2 Text")
                {

                }
                column(BoxWidth; "Box Width")
                {

                }
                column(BoxChar1; "Box Char 1")
                {

                }
                column(BoxLength; "Box Length")
                {

                }
                column(BoxChar2; "Box Char 2")
                {

                }
                column(BoxHeight; "Box Height")
                {

                }
                column(BoxChangedDate; "Box Changed Date")
                {


                }
                column(HarvestTempFrom; "Harvest Temp. From")
                {

                }
                column(HarvestTempTo; "Harvest Temp. To")
                {

                }

                column(FreezerHarvestTempFrom; "Freezer Harvest Temp. From")
                {

                }
                column(FreezerHarvestTempTo; "Freezer Harvest Temp. To")
                {

                }
                column(TransferTempFrom; "Transfer Temp. From")
                {

                }
                column(TransferTempTo; "Transfer Temp. To")
                {
            ...
            begin
                ...
                if "Requested Delivery Date" <> 0D then begin
                    vL_Date1 := CalcDate('-WD6', "Requested Delivery Date");
                    vL_Date2 := CalcDate('-WD6+1D', "Requested Delivery Date");
                    vL_Date3 := CalcDate('-WD6+2D', "Requested Delivery Date");
                    vL_Date4 := CalcDate('-WD6+3D', "Requested Delivery Date");
                    vL_Date5 := CalcDate('-WD6+4D', "Requested Delivery Date");
                    vL_Date6 := CalcDate('-WD6+5D', "Requested Delivery Date");
                    vL_Date7 := CalcDate('-WD6+6D', "Requested Delivery Date");
                    vL_Date8 := CalcDate('-WD6+7D', "Requested Delivery Date");
