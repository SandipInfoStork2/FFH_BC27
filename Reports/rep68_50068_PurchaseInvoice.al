report 50068 "Purchase - Invoice FFH"
{
    // TAL0.1 2018/08/30 VC add column Vendor Invoice No.
    // TAL0.2 2019/01/16 ANP removed logic to print GL account No.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep68_50068_PurchaseInvoice.rdlc';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(VATCounterLCY; "Integer")
                    {
                        ...
                        begin
                            ...
                            VALVATBaseLCY := Round(VATAmountLine."VAT Base" / "Purch. Inv. Header"."Currency Factor");
                            VALVATAmountLCY := Round(VATAmountLine."VAT Amount" / "Purch. Inv. Header"."Currency Factor");
                        end;
