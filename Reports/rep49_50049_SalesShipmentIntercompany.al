report 50049 "Sales - Shipment Intercompany"
{
    ...
    // TAL0.5 2021/04/20 VC add show comments for ifko boxes
    // TAL0.6 2021/11/03 VC Design COC No.
    // TAL0.7 2021/11/03 VC Option to Hide Global Gap
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep49_50049_SalesShipmentInterCompany.rdlc';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(TransferFrom; "Sales Shipment Header"."Transfer-from Code")
                    {

                    }
                    column(TransferTo; "Sales Shipment Header"."Transfer-to Code")
                    {
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        //=IIF(Fields!SelltoCustNo_SalesShptHeader.Value="CUST00032",False,True)
                        ...
                        //TAL 1.0.0.201 >>
                        column(TransferfromCodeCaption; TransferfromCodeLbl)
                        {
                        }
                        column(TransfertoCodeCaption; TransfertoCodeLbl)
                        {
                        }
                        ...
                        column(SSL_LocationCode; "Sales Shipment Line"."Location Code")
                        {
                        }
                        //TAL 1.0.0.201 <<
                        ...
                        begin
                            ...
                            vG_ItemReferenceNo := '';
                            if ("Sales Shipment Header"."Sell-to Customer No." = 'CUST00032') and (zshelfno <> '') then begin
                                vG_ItemReferenceNo := zshelfno;
                            end;

                            if vG_ItemReferenceNo = '' then begin
                                vG_ItemReferenceNo := "Sales Shipment Line"."Item Reference No.";
                            end;
                    ...
                    dataitem(ItemTrackingLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            if TrackingSpecBuffer."Lot No." <> '' then begin
                                ...
                                rG_ItemLedgerEntry.SetFilter("Document No.", "Sales Shipment Header"."No.");
    ...
    var
        //TAL 1.0.0.201 >>
        TransferfromCodeLbl: Label 'Transfer-from Code';
        TransfertoCodeLbl: Label 'Transfer-to Code';
        //TAL 1.0.0.201 <<
