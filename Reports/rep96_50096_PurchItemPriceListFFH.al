report 50096 "Purch. Item Price List FFH"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep96_50096_PurchaseItemPriceListFFH.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Purchase Item Price List';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            dataitem(SalesPrices; "Purchase Price")
            {
                ...
                column(SalesPriceUnitPrice; "Direct Unit Cost")
                {
                ...
                begin
                    ...
                    if rG_Vendor.Get("Vendor No.") then begin //Location.Code Getfilter("Location Code")
                ...
                begin
                    ...
                    vG_SalesCodeFilter := SalesPrices.GetFilter("Vendor No.");
    ...
    var
        ...
        UnitOfMeasureCaptionLbl: Label 'Purchase Unit of Measure';
    ...
    */
    ...
    begin
        ...
        //+TAL
        //if not TempSalesPrice.FindSet() then begin
        //    CurrReport.Skip();
        //end;
        //-TAL
    end;
