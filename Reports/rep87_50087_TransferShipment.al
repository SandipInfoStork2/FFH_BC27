report 50087 "Transfer Shipment FFH"
{
        ...
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ComName; VG_CompanyName.Name)
                    {
                    }
                    column(TransferToCode; "Transfer Shipment Header"."Transfer-to Code")
                    {
                    }
                    column(SalesPerson; "Transfer Shipment Header"."Salesperson Name")
                    {
                    }
    ...
    var
        ...
        VG_CompanyName: Record "Company Information";
}
