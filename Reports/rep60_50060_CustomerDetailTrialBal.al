report 50060 "Customer - Detail Trial Bal. F"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep60_50060_CustomerDetailTrialBal.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Customer - Detail Trial Bal. FFH';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Cust_Phone; "Phone No." + ' ' + "Mobile Phone No.")
            {
            }
