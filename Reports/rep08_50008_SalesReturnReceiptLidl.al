report 50008 "Sales - Return Receipt Lidl"
{
    // version NAVW110.0
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep08_50008_SalesReturnReceiptLidl.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Return Receipt Line"; "Return Receipt Line")
                    {
                        ...
                        //+1.0.0.297
                        column(CountryRegionofOriginCode; "Return Receipt Line"."Req. Country")
                        {
                        }
                        ...
                        column(Category9; "Return Receipt Line"."Category 9")
                        {
                        }
