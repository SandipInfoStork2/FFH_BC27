report 50041 "Sales - Invoice HORECA"
{
    ...
    // 
    // TAL0.2 2019/12/13 VC Design Customer Group dimension 5
    // TAL0.3 2019/12/19 VC add type item logic
    // TAL0.4 2019/12/23 VC review unit price size
    // TAL0.5 2019/12/23 VC review Footer Signature
    // TAL0.6 2020/11/2020 ANP Added Logic to hide 0 Lines
    // TAL0.7 2021/11/03 VC Design COC No.
    // TAL0.8 2021/11/03 VC Option to Hide Global Gap
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep41_50041_SalesInvoiceHORECA.rdlc';

    CaptionML = ELL = 'Sales - Invoice HORECA',
                ENU = 'Sales - Invoice HORECA';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            //+TAL0.2
                            Clear(vG_ShortcutDimCode); //TAL0.3
                            Clear(rG_DimensionValue); //TAL0.3
                            if "Sales Invoice Line".Type = "Sales Invoice Line".Type::Item then begin  //TAL0.3
                                DimMgt.GetShortcutDimensions("Sales Invoice Line"."Dimension Set ID", vG_ShortcutDimCode);
        ...
        layout
        {
            area(Content)
            {
                group(Options)
                {
                    ...
                    field("Show 0 Lines"; vG_ShowZeroQtyLines)
                    {
                        ToolTip = 'Specifies the value of the vG_ShowZeroQtyLines field.';
                        ApplicationArea = All;
                    }
