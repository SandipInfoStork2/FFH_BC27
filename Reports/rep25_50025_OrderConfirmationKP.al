report 50025 "Order Confirmation - KP"
{
    // version NAVW17.00

    // TAL0.1 2021/03/18 VC resize No., description, page margins
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep25_50025_OrderConfirmationKP.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(zShelfno; vG_ItemReferenceNo)
                        {
                        }
                        ...
                        begin
                            ...
                            if "Sales Line".Type = "Sales Line".Type::Item then
                                if zitem.Get("Sales Line"."No.") then
                                    zshelfno := zitem."Shelf No.";

                            //zshelfno shown only for Lidl
                            vG_ItemReferenceNo := '';
                            if ("Sales Header"."Sell-to Customer No." = 'CUST00032') and (zshelfno <> '') then begin
                                vG_ItemReferenceNo := zshelfno;
                            end;

                            if vG_ItemReferenceNo = '' then begin
                                vG_ItemReferenceNo := "Sales Line"."Item Reference No.";
                            end;
