report 50088 "Transfer Receipt FFH"
{
    // TAL0.2 ANP 2018/01/29  Added 4 fields (CompName,SalesPersonCode,SalesPersonName,TransToCode)
    // TAL0.1 VC 2018/01/22 Design Signatures, format header
    DefaultLayout = RDLC;
        ...
        dataitem("Transfer Receipt Header"; "Transfer Receipt Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompName; VG_CompanyNameShipReic.Name)
                    {
                    }
                    column(SalesPersonCode; "Transfer Receipt Header"."Salesperson Code")
                    {
                    }
                    column(SalesPersonName; "Transfer Receipt Header"."Salesperson Name")
                    {
                    }
                    column(TransToCode; "Transfer Receipt Header"."Transfer-to Code")
                    {
                    }
    ...
    var
        ...
        VG_CompanyNameShipReic: Record "Company Information";
}
