report 50011 "Boxes Statement Balances"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep11_50011_BoxesStatementBalances.rdlc';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(requeststartdate; requeststartdate)
            {
            }
            column(requestenddate; requestenddate)
            {
            }
            ...
            dataitem("Purchase Line Addon Posted"; "Purchase Line Addon Posted")
            {
                ...
                column(VariantText_PurchaseLineAddon; "Purchase Line Addon Posted"."Variant Text")
                {
                }
                column(obqty; obqty)
                {
                ...
                begin
                    ...
                    obPurchaseLineAddonPosted.SETRANGE(obPurchaseLineAddonPosted."Posted Date", 0D, requeststartdate - 1);
                    obqty := 0;
                ...
                begin
                    "Purchase Line Addon Posted".SETRANGE("Purchase Line Addon Posted"."Posted Date", requeststartdate - 99999, (requestenddate - 1));
                end;
            }
    ...
    var
        ...
        requestenddate: Date;
        obPurchaseLineAddonPosted: Record "Purchase Line Addon Posted";
        obqty: Decimal;
        hidedetails: Boolean;
}
