report 50066 "P.O. Order FFH"
{
    // TAL0.1 2021/12/22 VC align phone No.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/rep66_50066_PurchaseOrder.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(UOM_PurchLineCaption; 'UOM') //"Purchase Line".FieldCaption("Unit of Measure")
                        {
                        }
                        ...
                        column(ItemReferenceNo_PurchLineCaption; "Purchase Line"."Item Reference No.")
                        {
                        }
    ...
    var
        ...
        DirectUniCostCaptionLbl: Label 'Price'; //'Direct Unit Cost';
